        ...
        <div className='w-full md:w-3/4 p-2 bg-gray-100 border-2 rounded-lg'>
            ...
            <div className='mt-1 flex justify-end space-x-2'>
                <Button 
                    ...
                    text="Editor"
                    onClick={()=>{}}
                    className='justify-self-start rounded bg-transparent hover:bg-gray-300 text-black w-1/5'
                ...
                <Button 
                    ...
                    text="Photo"
                    onClick={()=>{}}
                    className='rounded bg-transparent hover:bg-gray-300 text-black w-1/5'
                ...
                />
                <Button
                    className='rounded-full bg-blue-500 w-1/5'
                    type='submit'
                    text='Publicar'
                />
            </div>
