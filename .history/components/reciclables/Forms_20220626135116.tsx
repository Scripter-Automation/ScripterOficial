...
export function Button({text, color, width, type, onClick, style, className, icon, count}:Button) {
  ...
  return (
    ...
    onClick={onClick}
    type={type}
    className={`bg-${color}-500 hover:bg-${color}-600  rounded p-1 w-${width} text-white text-lg ${className}`}
    >
      {icon !== undefined ? 
