...
export function ButtonLink({text, type, onClick, href, style, className}:Button) {
  return (
    ...
    onClick={onClick}
    type={type}
    className={`rounded p-2 text-white text-lg ${className}`}
    >{text}</button>
    </a>
...
export function Button({text, type, onClick, style, className, icon, count}:Button) {
  
  var classP1 = "w-2/5 sm:flex justify-center"
  var classP2 = 'w-3/5 text-left'

  if(count !== undefined){
    classP1 = "w-2/6 sm:flex justify-center"
    classP2 = 'w-2/6 text-left mr-2'
  }
  ...
  return (
    ...
    onClick={onClick}
    type={type}
    className={`rounded p-1 text-white text-lg ${className}`}
    >
      {icon !== undefined ? 
        <div className='flex items-center justify-center'>
          <div className={classP1}>{icon}</div>
          <div className={classP2}>{text}</div>
          {count !== undefined && <div className='w-2/6 text-left'>{count}</div>}
        </div>
        :
        <div>{text}</div>
      }
