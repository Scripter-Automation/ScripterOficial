  ...
  return (
    <div className='rounded-l-full rounded-r-full bg-gray-50 border-2'>
        <Button
            ...
            type='button'
            className='bg-transparent hover:bg-gray-200 text-black rounded-l-full w-1/3 '
        ...
        <Button
            text="Comentarios"
            type='button'
            className='bg-transparent hover:bg-gray-200 text-black rounded w-1/3'
        ...
        <Button
            text="Compartir"
            type='button'
            className='bg-transparent hover:bg-gray-300 text-black rounded-r-full rounded w-1/3 '
